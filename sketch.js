...
function setup() {
  ...
  M1=new mango(610,280,20)
  M2=new mango(510,250,20)
  M3=new mango(570,200,20)	
  M4=new mango(720,230,20)	
  M5=new mango(680,180,20)	
  M6=new mango(630,130,20)	
  M7=new mango(540,320,20)	
  M8=new mango(670,295,20)	
...
var dis=dist(mbp.x,mbp.y,sbp.x,sbp.y)
if(dis<=lmango.r+lstone.r){
